...
export default function LocaleSwitcher({ locale, alternates, className }: LocaleSwitcherProps) {
	...
	return (
		<a href={targetHref}
			 ...
			 className={`h-full flex flex-row items-center gap-1 text-gray-90 transition-colors duration-200 hover:text-primary hover:cursor-pointer focus-visible-facelift ${className}`}
		>
			<IconGlobe />
